/* NEXA desktop/auth stability v10.2 · 2026-09-04 */
(()=>{
'use strict';
if(window.__NEXA_DESKTOP_STABILITY_V102__) return;
window.__NEXA_DESKTOP_STABILITY_V102__=true;
...
function syncAuth(){
  ...
  if(loginOpen){try{window.scrollTo(0,0)}catch{};document.documentElement.classList.remove('n7-lock','n9-modal-lock')}
}
function addCss(){
...
@media(min-width:821px){
 ...
 body.nexa-clean-v7.n10-app-ready{--n7-side:178px;--n7-top:64px;overflow-x:hidden!important}
 ...
 body.nexa-clean-v7.n10-app-ready #n7Top>.n7-grow{display:block!important;flex:1 1 auto!important;min-width:8px!important}
 ...
 body.nexa-clean-v7.n10-app-ready .n7-rec{height:42px!important;min-width:260px!important;max-width:330px!important;padding:0 8px!important;gap:7px!important;display:flex!important;justify-content:flex-end!important;overflow:hidden!important;flex:0 1 330px!important}
 ...
 body.nexa-clean-v7.n10-app-ready .nexa-stage-host,body.nexa-clean-v7.n10-app-ready .panel-right,body.nexa-clean-v7.n10-app-ready .nexa-stage-view{box-sizing:border-box!important;width:100%!important;max-width:100%!important;min-width:0!important;margin-left:0!important;margin-right:0!important;overflow-x:hidden!important}
 body.nexa-clean-v7.n10-app-ready .nexa-stage-view.active{padding-left:0!important;padding-right:0!important;transform:none!important}
 body.nexa-clean-v7.n10-app-ready .nexa-stage-view[data-stage="radar"].active{display:grid!important;grid-template-columns:minmax(0,1.08fr) minmax(0,.92fr)!important;gap:12px!important;align-items:start!important}
 body.nexa-clean-v7.n10-app-ready .nexa-stage-view[data-stage="radar"]>#realtimeRadarCard,body.nexa-clean-v7.n10-app-ready .nexa-stage-view[data-stage="radar"]>.card.rec-zone,body.nexa-clean-v7.n10-app-ready #nexaRadarAlertsDock,body.nexa-clean-v7.n10-app-ready #nexaDispositionCard{min-width:0!important;max-width:100%!important;box-sizing:border-box!important}
 body.nexa-clean-v7.n10-app-ready .nexa-stage-view[data-stage="radar"]>.card.rec-zone{grid-column:2!important;grid-row:1!important;width:100%!important}
 body.nexa-clean-v7.n10-app-ready #realtimeRadarCard{grid-column:1!important;width:100%!important}
 ...
 /* Other clinical tabs keep their own internal layout; only the outer canvas is normalized. */
 ...
 body.nexa-clean-v7.n10-app-ready .nexa-stage-view[data-stage="history"].active{display:block!important;width:100%!important;max-width:1180px!important;margin:0 auto!important;overflow:visible!important}
 body.nexa-clean-v7.n10-app-ready .nexa-stage-view[data-stage="summary"].active>*,
 body.nexa-clean-v7.n10-app-ready .nexa-stage-view[data-stage="hypothesis"].active>*,
 body.nexa-clean-v7.n10-app-ready .nexa-stage-view[data-stage="plan"].active>*,
 body.nexa-clean-v7.n10-app-ready .nexa-stage-view[data-stage="history"].active>*{max-width:100%!important;box-sizing:border-box!important}
}

@media(min-width:821px) and (max-width:1250px){
 body.nexa-clean-v7.n10-app-ready{--n7-side:154px;--n7-top:60px}
 ...
 body.nexa-clean-v7.n10-app-ready .n7-rec{height:38px!important;min-width:235px!important;max-width:285px!important;flex-basis:285px!important;gap:5px!important}
 ...
 body.nexa-clean-v7.n10-app-ready .nexa-stage-view[data-stage="radar"].active{grid-template-columns:minmax(0,1.03fr) minmax(0,.97fr)!important;gap:8px!important}
}
`;
...
function clampViewport(){
 ...
 [document.documentElement,document.body,$('mainApp'),q('#mainApp>main'),q('.nexa-stage-host')].filter(Boolean).forEach(el=>{try{el.style.setProperty('overflow-x','hidden','important')}catch{}});
 try{if(window.scrollX)window.scrollTo(0,window.scrollY)}catch{}
}
