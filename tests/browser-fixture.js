...
(()=>{
 ...
 const url=String(input?.url||input);if(url.includes('.supabase.co')){
  ...
  if(url.includes('protocol-library'))return Response.json({items:[{id:'11111111-1111-4111-8111-111111111111',title:'Condição QA',diagnosis_key:'condicao-qa',cid10:['J45'],match_terms:['condição qa','termo qa'],version:{id:'22222222-2222-4222-8222-222222222222',version_no:3,clinical_scope:'Contexto sintético QA.',source_label:'Fonte sintética QA',source_page:'1',prescription_text:'',prescription_items:[{principio_ativo:'ITEM QA',apresentacao:'FORMATO QA',quantidade_total:'QTD QA',via:'outra',manual_text:'INSTRUÇÃO SINTÉTICA QA',categoria:'QA',sugerido:true}],guidance_text:'Orientação sintética QA.',criteria_text:'Critério sintético QA.',contraindications_text:'Texto sintético QA.',required_data_text:'Dados sintéticos QA.',published_at:'2026-09-25T00:00:00Z'}}],total:1});
