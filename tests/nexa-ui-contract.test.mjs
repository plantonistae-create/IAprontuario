...
assert.ok(loader.includes('20260907-v1898'));
assert.ok(loader.lastIndexOf('nexa-sic-documentation-rule-v18.9.8.js')>loader.lastIndexOf('nexa-recording-timer-state-v18.9.8.js'));
...
assert.ok(sw.includes('20260907-v1898'));
assert.ok(sw.includes('cache:"no-store"'));
new Function(loader);new Function(layout);new Function(draft);new Function(mobile);new Function(mobileFlow);new Function(exact);new Function(panelQueue);new Function(medicalState);new Function(radarStable);new Function(hsa);new Function(timerGuard);new Function(sicRule);new Function(sw);
console.log('NEXA v18.9.8 recorder timer + SIC documentation: PASS');
