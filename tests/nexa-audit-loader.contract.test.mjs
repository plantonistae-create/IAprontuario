...
assert.ok(loader.lastIndexOf('nexa-audit-ui-integrity-v18.9.16.js')>loader.lastIndexOf('nexa-audit-functional-guard-v18.9.16.js'));
...
new Function(guard);new Function(uiIntegrity);
